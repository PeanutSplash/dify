const translation = {
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、AIGC_lab Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  licenseExpiredTip: 'ワークスペースの AIGC_lab Enterprise ライセンスの有効期限が切れています。Difyを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの AIGC_lab Enterprise ライセンスが非アクティブです。Difyを引き続き使用するには、管理者に連絡してください。',
