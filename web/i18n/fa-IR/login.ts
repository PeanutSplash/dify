const translation = {
  ...
  welcome: 'به AIGC_lab خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع AIGC_lab Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در AIGC_lab',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش AIGC_lab',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در AIGC_lab استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز AIGC_lab Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از AIGC_lab با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز AIGC_lab Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از AIGC_lab با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز AIGC_lab انجام نشد. لطفا برای ادامه استفاده از AIGC_lab با سرپرست خود تماس بگیرید.',
}
