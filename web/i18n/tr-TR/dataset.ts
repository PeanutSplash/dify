const translation = {
  ...
  intro1: 'Bilgi, AIGC_lab uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, AIGC_lab dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
