const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AIGC_lab hesabı',
    langGeniusAccountTip: 'AIGC_lab hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, AIGC_lab\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'AIGC_lab tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, AIGC_lab\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} şimdi mevcut.',
    latestAvailable: 'AIGC_lab {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
