const translation = {
  ...
  welcome: 'AIGC_lab\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'AIGC_lab Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'AIGC_lab\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için AIGC_lab Enterprise lisansının süresi doldu. AIGC_lab\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'AIGC_lab lisans sunucusuna bağlanılamadı. AIGC_lab\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için AIGC_lab Enterprise lisansı etkin değil. AIGC_lab\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
