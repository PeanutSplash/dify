const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account AIGC_lab',
    langGeniusAccountTip: 'Il tuo account AIGC_lab e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a AIGC_lab per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da AIGC_lab ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di AIGC_lab.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} è ora disponibile.',
    latestAvailable: 'AIGC_lab {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
