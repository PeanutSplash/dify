const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di AIGC_lab con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di AIGC_lab.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di AIGC_lab Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
