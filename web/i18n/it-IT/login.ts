const translation = {
  ...
  welcome: 'Benvenuto su AIGC_lab, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare AIGC_lab Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su AIGC_lab',
  invalid: 'Il link è scaduto',
  explore: 'Esplora AIGC_lab',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su AIGC_lab e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze AIGC_lab. Contatta il tuo amministratore per continuare a utilizzare AIGC_lab.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza AIGC_lab Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare AIGC_lab.',
  licenseInactiveTip: 'La licenza AIGC_lab Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare AIGC_lab.',
