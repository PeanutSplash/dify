const translation = {
  list: {
    title: 'Документы',
    desc: 'Здесь отображаются все файлы базы знаний, и вся база знаний может быть связана с цитатами AIGC_lab или проиндексирована с помощью чата.',
    ...
    empty: {
      ...
      sync: {
        tip: 'AIGC_lab будет периодически загружать файлы из вашего Notion и завершать обработку.',
      },
    },
    delete: {
