const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von AIGC_lab mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      embedded: {
        ...
        chromePlugin: 'Installieren Sie die AIGC_lab Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
