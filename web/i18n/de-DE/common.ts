const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AIGC_lab-Konto',
    langGeniusAccountTip: 'Ihr AIGC_lab-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei AIGC_lab anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von AIGC_lab ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} ist jetzt verfügbar.',
    latestAvailable: 'AIGC_lab {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
