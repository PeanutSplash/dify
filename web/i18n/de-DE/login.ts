const translation = {
  ...
  welcome: 'Willkommen bei AIGC_lab, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AIGC_lab Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AIGC_lab beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AIGC_lab erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei AIGC_lab angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des AIGC_lab-Lizenzservers. Wenden Sie sich an Ihren Administrator, um AIGC_lab weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die AIGC_lab Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um AIGC_lab weiterhin zu verwenden.',
  licenseExpiredTip: 'Die AIGC_lab Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um AIGC_lab weiterhin zu verwenden.',
