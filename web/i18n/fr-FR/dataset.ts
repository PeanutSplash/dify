const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application AIGC_lab',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de AIGC_lab et récupérer des connaissances de cette base de connaissances.',
