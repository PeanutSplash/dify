const translation = {
  ...
  welcome: 'Bienvenue sur AIGC_lab, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer AIGC_lab Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur AIGC_lab',
  invalid: 'Le lien a expiré',
  explore: 'Explorez AIGC_lab',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur AIGC_lab et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence AIGC_lab Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser AIGC_lab.',
  licenseLostTip: 'Échec de la connexion au serveur de licences AIGC_lab. Veuillez contacter votre administrateur pour continuer à utiliser AIGC_lab.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence AIGC_lab Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser AIGC_lab.',
