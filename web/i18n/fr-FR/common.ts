const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte AIGC_lab',
    langGeniusAccountTip: 'Votre compte AIGC_lab et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à AIGC_lab pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par AIGC_lab vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de AIGC_lab.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} est maintenant disponible.',
    latestAvailable: 'AIGC_lab {{version}} est la dernière version disponible.',
  },
  appMenus: {
