const translation = {
  ...
  welcome: 'Chào mừng bạn đến với AIGC_lab, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của AIGC_lab, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại AIGC_lab',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá AIGC_lab',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên AIGC_lab và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
  ...
  licenseInactiveTip: 'Giấy phép AIGC_lab Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng AIGC_lab.',
  licenseExpired: 'Giấy phép đã hết hạn',
  licenseExpiredTip: 'Giấy phép AIGC_lab Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng AIGC_lab.',
  licenseLostTip: 'Không thể kết nối máy chủ cấp phép AIGC_lab. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng AIGC_lab.',
}
