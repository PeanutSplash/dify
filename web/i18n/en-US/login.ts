const translation = {
  ...
  welcome: '👋 Welcome to AIGC_lab, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting AIGC_lab Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on AIGC_lab',
  invalid: 'The link has expired',
  explore: 'Explore AIGC_lab',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on AIGC_lab and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The AIGC_lab Enterprise license for your workspace has expired. Please contact your administrator to continue using AIGC_lab.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect AIGC_lab license server. Please contact your administrator to continue using AIGC_lab.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The AIGC_lab Enterprise license for your workspace is inactive. Please contact your administrator to continue using AIGC_lab.',
}
