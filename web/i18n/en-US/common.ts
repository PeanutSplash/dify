const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AIGC_lab account',
    langGeniusAccountTip: 'Your AIGC_lab account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to AIGC_lab to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AIGC_lab allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across AIGC_lab\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} is now available.',
    latestAvailable: 'AIGC_lab {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
