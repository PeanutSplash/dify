const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to AIGC_lab citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'AIGC_lab will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
