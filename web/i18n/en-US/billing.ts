const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refers to the number of API calls invoking only the knowledge base processing capabilities of AIGC_lab.',
  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'Single Workspace',
        'Complies with AIGC_lab Open Source License',
      ],
    },
    premium: {
      name: 'Premium',
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO',
        'Negotiated SLAs by AIGC_lab Partners',
        'Advanced Security & Controls',
        'Updates and Maintenance by AIGC_lab Officially',
