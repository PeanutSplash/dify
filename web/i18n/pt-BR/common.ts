const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta AIGC_lab',
    langGeniusAccountTip: 'Sua conta AIGC_lab e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no AIGC_lab para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela AIGC_lab permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da AIGC_lab.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} já está disponível.',
    latestAvailable: 'AIGC_lab {{version}} é a última versão disponível.',
  },
  appMenus: {
