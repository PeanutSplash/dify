const translation = {
  ...
  welcome: 'Bem-vindo ao AIGC_lab, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AIGC_lab, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AIGC_lab',
  invalid: 'O link expirou',
  explore: 'Explorar o AIGC_lab',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no AIGC_lab e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do AIGC_lab Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o AIGC_lab.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças AIGC_lab. Entre em contato com o administrador para continuar usando o AIGC_lab.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do AIGC_lab Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o AIGC_lab.',
}
