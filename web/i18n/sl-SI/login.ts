const translation = {
  ...
  welcome: 'Dobrodošli v AIGC_lab, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z AIGC_lab Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na AIGC_lab',
  invalid: 'Povezava je potekla',
  explore: 'Razišči AIGC_lab',
  ...
  licenseExpiredTip: 'Licenca za AIGC_lab Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati AIGC_lab, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na AIGC_lab, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom AIGC_lab ni uspela. Če želite še naprej uporabljati AIGC_lab, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca AIGC_lab Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati AIGC_lab, se obrnite na skrbnika.',
}
