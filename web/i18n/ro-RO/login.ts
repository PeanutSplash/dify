const translation = {
  ...
  welcome: 'Bine ai venit la AIGC_lab, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe AIGC_lab Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe AIGC_lab',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează AIGC_lab',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe AIGC_lab și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe AIGC_lab. Contactați administratorul pentru a continua să utilizați AIGC_lab.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența AIGC_lab Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați AIGC_lab.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența AIGC_lab Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați AIGC_lab.',
}
