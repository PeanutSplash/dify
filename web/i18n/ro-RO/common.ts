const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont AIGC_lab',
    langGeniusAccountTip: 'Contul AIGC_lab și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în AIGC_lab pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de AIGC_lab vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile AIGC_lab.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} este acum disponibil.',
    latestAvailable: 'AIGC_lab {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
