const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a AIGC_lab cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a AIGC_lab.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome AIGC_lab Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
