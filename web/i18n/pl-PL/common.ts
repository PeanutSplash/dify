const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto AIGC_lab',
    langGeniusAccountTip: 'Twoje konto AIGC_lab i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do AIGC_lab, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez AIGC_lab pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach AIGC_lab.',
  ...
  about: {
    ...
    nowAvailable: 'AIGC_lab {{version}} jest teraz dostępny.',
    latestAvailable: 'AIGC_lab {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
