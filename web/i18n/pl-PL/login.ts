const translation = {
  ...
  welcome: 'Witaj w AIGC_lab, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej AIGC_lab, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na AIGC_lab',
  invalid: 'Link wygasł',
  explore: 'Odkryj AIGC_lab',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w AIGC_lab, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja AIGC_lab Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z AIGC_lab.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji AIGC_lab. Skontaktuj się z administratorem, aby kontynuować korzystanie z AIGC_lab.',
  licenseInactiveTip: 'Licencja AIGC_lab Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z AIGC_lab.',
}
