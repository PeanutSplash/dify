const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją AIGC_lab ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza AIGC_lab i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
